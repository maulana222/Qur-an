...
<head>
    ...
    <link href="<?= base_url()?>assets/v<?= base_url()?>assets/endor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= site_url('Auth/Daftar')?>">
